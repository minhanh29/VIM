...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#FAFAFA",  'mirage': "#23262B"}

let s:palette.comment   = {'dark': "#5C6773",  'light': "#ABB0B6",  'mirage': "#6C7987"}
let s:palette.markup    = {'dark': "#F07178",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#FFEE99",  'light': "#A37ACC",  'mirage': "#A87EFC"}
...
let s:palette.keyword   = {'dark': "#FF7733",  'light': "#FF7733",  'mirage': "#FF7C30"}
...
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#6C7987"}
